...
void main_window_load(Window *window) {
    ...
    s_background_layer = bitmap_layer_create(GRect(mCenterX - px(65), mCenterY - px(140), px(130), px(120)));
    bitmap_layer_set_bitmap(s_background_layer, s_logo_bitmap);
    layer_add_child(window_layer, bitmap_layer_get_layer(s_background_layer));

    s_time_font = fonts_load_custom_font(resource_get_handle(RESOURCE_ID_FONT_ALARM_CLOCK_50));
    ...
    s_battery_layer = text_layer_create(GRect(mCenterX - px(40), mCenterY - px(205), px(90), px(40)));
